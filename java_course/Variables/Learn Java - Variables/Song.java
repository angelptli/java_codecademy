...
data with no built-in behavior. Our programs will also use String, which are
objects, instead of primitives. Objects have built-in behavior.

String hold sequences of characters. We've already seen instances of a String,
for example, when we printed out "Hellow World". There are two ways to create a
String object: using a String literal or calling the String class to create a
new String object.
...
String using a String literal or new String object. We'll dive into those later,
...
Using the \\ escape sequence allows use to place backslashes in our String text:
/////////////////////////////////////////////////////////////
System.out.println("This is the backslash symbol: \\");
/////////////////////////////////////////////////////////////

This is similar to the last example - just like ", \ usually has a special
meaning. In this case, \ is used to start an escape sequence. Well, if we don't
want to start an escape sequence and just want a \ in our String, then we'll
use \\ - we're using an escape sequence to say that we don't want \ to be
interpreted as the start of an escape sequence. It's a little mind-bending!

Finally, if we place a \n escape sequence in a String, the compiler will output
a new line of text:
...
Instructions
------------
1. Create a variable called openingLyrics that holds "Yesterday, all my troubles
   seemed so far away".
