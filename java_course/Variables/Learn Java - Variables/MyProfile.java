...
Review
------
Creating and filling variables is a powerful concept that allows us to keep
track of all kinds of data in our program.
...
Instructions
------------
1. The file MyProfile.java contains a class that represents your hiring profile
   as presented to potential employers. In the main() method, create a variable
   called name that holds your name, as a sequence of characters.

2. Create a variable called age that holds your age as a whole number.

3. Create a variable called desiredSalary that holds your desired salary per
   year to a precision of two decimal points.

4. Create a variable called gender that holds a single character, m (male),
   f (female), n (for none), or o (for other).

5. Create a variable called lookingForJob that holds wheter or not you are
   currently open to job offers.
================================================================================
*/
// public class MyProfile {
//     public static void main(String[] args) {
//         String name = "Angel Li";
//         int age = 23;
//         double desiredSalary = 120000.00;
//         char gender = 'f';
