...
very common in programming. You often see them used to store ages, or maximum
...
int holds positive numbers, negative numbers, and zero. They do not stored
fractions or numbers with decimals in them.

The int data type allows values between -2,147,483,648 and 2,147,483,648.
...
Instructions
------------
1. The file CountComment.java has a number of comments in it. In your head,
   count the number of comments. Then, inside the main() method, declare a
   variable called numComments that holds how many comments you counted.
