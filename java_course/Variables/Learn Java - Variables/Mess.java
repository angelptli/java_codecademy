...
if a variable is assigned a value of an incorrect type. This is a bug,
...
Instructions
------------
1. In the Mess.java file, we have declared a bunch of variables with the wrong
   type. Try to compile the file using the command:
   //////////////////////
   javac Mess.java
   //////////////////////

2. Change the types of the variables so that they correspond with the type of
   the assignment values. For example, year is assigned 2001, so it should be
   an int.
