...
letter of each subsequent word is capitalized. This stype of capitalization is
called camelCase.
/////////////////////////////////////////
// good style
boolean isHuman;
...
Instructions
------------
1. In the BadNames.java file, we declared variables with confusing names. Run
   the file and look at the error messages you get when trying to compile.

2. Some of these variable names are illegal! Change the ones that are preventing
